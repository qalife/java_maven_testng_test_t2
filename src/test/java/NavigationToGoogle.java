...
public class NavigationToGoogle {
    public static void main(String[] args) {
        System.setProperty("webdriver.chrome.driver", System.getProperty("user.home")+"/Desktop/java_maven_testng_test_t2/src/main/resources/chromedriver");
    ...
    public static void main2(String[] args) {
        System.setProperty("webdriver.chrome.driver", "/Users/val/Downloads/qastarting_java_test/src/main/resources/chromedriver");
        WebDriver drChrome = new ChromeDriver();
